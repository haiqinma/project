...
- **emit（10）**
  ...
  - `resources/assets/js/pages/manage.vue:1214`
  - `resources/assets/js/pages/manage.vue:1221`
  - `resources/assets/js/pages/manage/application.vue:1189`
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:5330`
- **on（1）**
...
- **emit（7）**
  ...
  - `resources/assets/js/pages/manage.vue:1245`
...
- **emit（1）**
  - `resources/assets/js/pages/manage.vue:1233`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage.vue:1114`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage/application.vue:1062`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage/application.vue:1109`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage.vue:1619`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage/application.vue:1059`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/pages/manage/dashboard.vue:255`
- **on（1）**
...
- **emit（2）**
  - `resources/assets/js/pages/manage.vue:1111`
...
- **on（1）**
  - `resources/assets/js/pages/login.vue:233`
- **off（1）**
  - `resources/assets/js/pages/login.vue:238`
